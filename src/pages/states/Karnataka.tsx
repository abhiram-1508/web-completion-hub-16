...
const Karnataka = () => {
  const famousPlaces = [
    ...
    },
    {
      ...
      visitTime: "2-3 hours",
      bestTime: "October to March, evening illumination"
    },
    {
      name: "Hampi Ruins",
      image: hampiRuinsImg,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-foreground font-medium">Karnataka</span>
                </div>
                <h1 className="text-5xl md:text-6xl font-bold mb-6">
                  <span className="gradient-text">Karnataka</span>
                  <span className="block text-3xl md:text-4xl mt-2 text-muted-foreground">
                    Silicon Valley of India
                  </span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Discover Karnataka's unique blend of modern technology, royal heritage, 
                  and ancient ruins spanning centuries of South Indian history.
                </p>
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>65+ Million Population</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Clock className="h-4 w-4 text-primary" />
                    <span>Ancient to Modern Heritage</span>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience Karnataka's journey from ancient kingdoms to modern innovation
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-cultural-purple via-cultural-gold to-cultural-amber rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold">
                  Experience Karnataka's Heritage
                </h2>
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  From ancient temple ruins to modern tech hubs, discover the evolution of Karnataka's cultural landscape.
                </p>
