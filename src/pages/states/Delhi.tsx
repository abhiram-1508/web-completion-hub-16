            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-foreground font-medium">Delhi</span>
                </div>
                <h1 className="text-5xl md:text-6xl font-bold mb-6">
                  <span className="gradient-text">Delhi</span>
                  <span className="block text-3xl md:text-4xl mt-2 text-muted-foreground">
                    India's Historic Capital
                  </span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Explore the capital city where ancient history meets modern India, featuring 
                  magnificent Mughal architecture and iconic national monuments.
                </p>
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>30+ Million Population</span>
                  </div>
                  <div className="flex items-center space-x-2">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Discover Delhi's most iconic landmarks that tell the story of India's rich heritage
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cultural-teal via-cultural-blue to-cultural-purple rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold">
                  Experience Delhi's Heritage
                </h2>
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  Immerse yourself in the capital's rich history through virtual tours and interactive experiences.
                </p>
