import { MapPin, Camera, Clock, Users, Waves } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-foreground font-medium">Kerala</span>
                </div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Experience the tropical paradise of Kerala with its serene backwaters, 
                  lush tea gardens, and rich cultural traditions.
                </p>
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>35+ Million Population</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Waves className="h-4 w-4 text-primary" />
                    <span>Backwater Paradise</span>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Discover Kerala's natural beauty and cultural treasures
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-cultural-teal via-cultural-blue to-cultural-green rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  From tranquil backwaters to misty mountains, discover Kerala's unique blend of natural beauty and cultural richness.
                </p>
