            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-foreground font-medium">Bihar</span>
                </div>
                <h1 className="text-5xl md:text-6xl font-bold mb-6">
                  <span className="gradient-text">Bihar</span>
                  <span className="block text-3xl md:text-4xl mt-2 text-muted-foreground">
                    Land of Buddha
                  </span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Discover the birthplace of Buddhism and ancient seat of learning, 
                  where spiritual enlightenment and knowledge flourished.
                </p>
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>125+ Million Population</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Clock className="h-4 w-4 text-primary" />
                    <span>Ancient Buddhist Heritage</span>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience Bihar's profound spiritual and educational heritage
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cultural-purple via-cultural-gold to-cultural-amber rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold">
                  Experience Spiritual Bihar
                </h2>
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  Journey through the land where Buddha found enlightenment and ancient universities shaped world knowledge.
                </p>
