    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="text-foreground font-medium">Tamil Nadu</span>
                </div>
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Discover the cultural heartland of South India, renowned for its magnificent temples, 
                  classical arts, and rich Dravidian heritage.
                </p>
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>75+ Million Population</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Clock className="h-4 w-4 text-primary" />
                    <span>2000+ Years of Heritage</span>
                  </div>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience the magnificent temples, beaches, and hill stations of Tamil Nadu
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-cultural-gold via-cultural-amber to-cultural-purple rounded-3xl p-12 md:p-20 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold">
                  Experience Tamil Nadu's Culture
                </h2>
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  From ancient temples to coastal beauty, discover the rich Dravidian heritage and traditions.
                </p>
