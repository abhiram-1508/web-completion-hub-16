...
import uttarPradeshImg from "@/assets/Uttar pradesh.png";
import himachalPradeshImg from "@/assets/Himachal Pradesh.png";
import tamilNaduImg from "@/assets/Tamil Nadu.png";
import keralaImg from "@/assets/Kerala.png";
import karnatakaImg from "@/assets/Karnataka.png";
import westBengalImg from "@/assets/west bengal.png";
...
import maharashtraImg from "@/assets/maharsatra.png";
import gujaratImg from "@/assets/gujarat.png";
                    ...
                    <div className="p-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        {region.states.map((state, stateIndex) => {
                          ...
                          const imgSrc = stateImages[state.name] || ancientTemple;
                          return (
                            <div key={stateIndex} className="rounded-xl shadow-lg bg-card/80 border border-muted/40 overflow-hidden flex flex-col hover:scale-105 transition-transform duration-300">
                              <div className="relative h-32 w-full overflow-hidden bg-muted flex items-center justify-center">
                                <img
                                  src={imgSrc}
                                  alt={state.name === 'Karnataka' ? 'Karnataka state cover showing Hampi, Mysore Palace, and local culture' : state.name + ' image'}
